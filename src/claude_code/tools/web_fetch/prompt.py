...
def make_secondary_model_prompt(
    ...
    """Create a prompt for the secondary model to process fetched content.

    Args:
        markdown_content: The fetched and converted markdown content
        prompt: The user's prompt describing what to extract
        is_preapproved_domain: Whether the domain is pre-approved for less restrictive handling

    Returns:
        The formatted prompt for the secondary model
    """

"""List MCP resources tool. Migrated from tools/ListMcpResourcesTool/ListMcpResourcesTool.ts."""
...
from .prompt_text import DESCRIPTION, LIST_MCP_RESOURCES_TOOL_NAME

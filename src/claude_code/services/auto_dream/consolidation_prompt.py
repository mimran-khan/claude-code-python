"""
Dream / memory consolidation prompt (shared by manual /dream and auto-dream).

Migrated from: services/autoDream/consolidationPrompt.ts
"""

from __future__ import annotations

from claude_code.memdir.memory import DIR_EXISTS_GUIDANCE, ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES


def build_consolidation_prompt(memory_root: str, transcript_dir: str, extra: str) -> str:
    body = f"""# Dream: Memory Consolidation
